...
public class Axis3DL implements AxisRotator {
    ...
    public Vec3f getRelativeVector(Vec3f vec){
        ...
        mat.rotate(roll  * 3.14159265F / 180, new Vector3f(1F, 0F, 0F));
        mat.rotate(pitch * 3.14159265F / 180, new Vector3f(0F, 0F, 1F));
        mat.rotate(yaw   * 3.14159265F / 180, new Vector3f(0F, 1F, 0F));
