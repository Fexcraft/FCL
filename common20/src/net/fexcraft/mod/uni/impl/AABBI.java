 ...
 */
public class AABBI extends net.fexcraft.mod.uni.world.AABB {
	...
	@Override
	public net.fexcraft.mod.uni.world.AABB set(float sx, float sy, float sz, float ex, float ey, float ez){
	...
	@Override
	public net.fexcraft.mod.uni.world.AABB offset(int x, int y, int z){
		AABB nbb = new AABB(aabb.minX + x, aabb.minY + y, aabb.minZ + z, aabb.maxX + x, aabb.maxY + y, aabb.maxZ + z);
		return new AABBI(nbb);
	}

	@Override
	public net.fexcraft.mod.uni.world.AABB offset(V3D vec){
